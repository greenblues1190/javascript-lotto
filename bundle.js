...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html {\n  font-family: 'Roboto', sans-serif;\n  font-size: 15px;\n}\n\nbody {\n  letter-spacing: 0.5px;\n}\n\n#app {\n  position: absolute;\n  left: 50%;\n  transform: translate(-50%);\n  margin-top: 52px;\n  width: 382px;\n  min-height: 640px;\n\n  border: 1px solid rgba(0, 0, 0, 0.12);\n  border-radius: 4px;\n  padding: 0 16px;\n\n  display: flex;\n  flex-direction: column;\n}\n\n.title {\n  text-align: center;\n  margin-top: 52px;\n  margin-bottom: 16px;\n  font-weight: 600;\n  font-size: 34px;\n  line-height: 36px;\n}\n\n.main-wrap {\n  display: flex;\n  flex-direction: column;\n  gap: 28px;\n}\n\n.subtitle {\n  font-weight: 600;\n  font-size: 20px;\n  line-height: 24px;\n  letter-spacing: 0.15px;\n}\n\n.input-form {\n  /* display: flex; */\n  justify-content: space-between;\n}\n\n.hint {\n  display: block;\n  margin-bottom: 4px;\n  line-height: 24px;\n  font-weight: 400;\n  color: rgba(0, 0, 0, 0.87);\n}\n\n.winning-number-legend {\n  display: block;\n  margin-bottom: 4px;\n  line-height: 24px;\n  font-weight: 400;\n  color: rgba(0, 0, 0, 0.87);\n}\n\n.styled-input {\n  height: 36px;\n  border: 1px solid #b4b4b4;\n  box-sizing: border-box;\n  border-radius: 4px;\n}\n\n.styled-input:placeholder {\n  margin: 0px 10px;\n\n  font-family: Roboto;\n  font-style: normal;\n  font-weight: normal;\n  font-size: 15px;\n  line-height: 24px;\n\n  letter-spacing: 0.5px;\n  color: #8b8b8b;\n}\n\n.submit-button {\n  background: inherit;\n  border: none;\n  box-shadow: none;\n  overflow: visible;\n  cursor: pointer;\n\n  background: #00bcd4;\n  border-radius: 4px;\n  color: #fff;\n\n  font-style: normal;\n  font-weight: bold;\n  font-size: 14px;\n  line-height: 16px;\n\n  letter-spacing: 1.25px;\n  text-transform: uppercase;\n\n  height: 36px;\n}\n\n.submit-button:hover {\n  background: #80deea;\n}\n\n.submit-button:disabled {\n  background: #b4b4b4;\n}\n\n#payment-input {\n  width: 310px;\n}\n\n#payment-submit {\n  width: 56px;\n  float: right;\n}\n\n#ticket-section {\n  display: flex;\n  justify-content: space-between;\n}\n\n#ticket-list {\n  display: flex;\n  gap: 8px;\n  flex-wrap: wrap;\n  width: 286px;\n}\n\n#ticket-list {\n  display: flex;\n  gap: 8px;\n  flex-wrap: wrap;\n  width: 286px;\n}\n\n.ticket-list-row {\n  flex-direction: row;\n}\n\n.ticket-list-column {\n  flex-direction: column;\n}\n\n.ticket {\n  height: 36px;\n  font-size: 34px;\n  line-height: 36px;\n}\n\n.ticket > p {\n  width: max-content;\n  display: flex;\n}\n\n.ticket-numbers {\n  font-style: normal;\n  font-weight: normal;\n  font-size: 15px;\n  line-height: 36px;\n  vertical-align: middle;\n  margin-left: 8px;\n}\n\n#show-number-toggle-area {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n}\n\n.switch {\n  position: relative;\n  display: inline-block;\n}\n\n/* Hide default HTML checkbox */\n.switch input {\n  width: 30px;\n  height: 10px;\n  visibility: hidden;\n}\n\n/* The slider */\n.slider {\n  position: absolute;\n  cursor: pointer;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(33, 33, 33, 0.08);\n  -webkit-transition: 0.4s;\n  transition: 0.4s;\n}\n\n.slider:before {\n  position: absolute;\n  content: '';\n  height: 20px;\n  width: 20px;\n  left: 0px;\n  bottom: -3px;\n  background-color: rgb(250, 248, 248);\n  -webkit-transition: 0.4s;\n  transition: 0.4s;\n}\n\n/* switch on: background bar */\ninput:checked + .slider {\n  background-color: #80deea;\n}\n\n/* switch on : round */\ninput:checked + .slider:before {\n  -webkit-transform: translateX(14px);\n  -ms-transform: translateX(14px);\n  transform: translateX(14px);\n  background-color: #00bcd4;\n}\n\n/* Rounded sliders */\n.slider.round {\n  border-radius: 34px;\n  width: 34px;\n  height: 14px;\n}\n\n.slider.round:before {\n  border-radius: 50%;\n  box-shadow: 0 2px 2px rgba(0, 0, 0, 0.2);\n}\n\n#winning-number-section {\n  display: flex;\n  flex-direction: column;\n}\n\n#winning-number-form {\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 24px;\n}\n\n#winning-number-input-wrap {\n  display: flex;\n  gap: 8px;\n}\n\n.winning-number-input {\n  width: 34px;\n  text-align: center;\n}\n\n.winning-number-input::-webkit-outer-spin-button,\n.winning-number-input::-webkit-inner-spin-button {\n  -webkit-appearance: none;\n  margin: 0;\n}\n\n#bonus-number-fieldset {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n}\n\n#show-result-button {\n  margin-bottom: 39px;\n}\n\n.modal-overlay {\n  width: 100%;\n  height: 100%;\n  position: fixed;\n  left: 0;\n  top: 0;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: rgba(0, 0, 0, 0.3);\n}\n\n.modal-closed {\n  display: none;\n}\n\n.modal-window {\n  width: 350px;\n  padding: 40px 16px;\n  display: flex;\n  flex-direction: column;\n  gap: 32px;\n  align-items: center;\n  justify-content: center;\n  background: rgba(255, 255, 255);\n  border-radius: 4px;\n  border: 1px solid rgba(255, 255, 255);\n}\n\n.modal-content {\n  width: 100%;\n  text-align: center;\n}\n\n#result-table {\n  width: 100%;\n  border-top: 1px solid #dcdcdc;\n  border-collapse: collapse;\n  margin-bottom: 16px;\n}\n\n#result-table th {\n  border-bottom: 1px solid #dcdcdc;\n  padding: 10px;\n  font-weight: bold;\n}\n\n#result-table td {\n  border-bottom: 1px solid #dcdcdc;\n  padding: 10px;\n}\n\n#restart-button {\n  padding: 0 30px;\n}\n", "",{"version":3,"sources":["webpack://./src/css/index.css"],"names":[],"mappings":"AAAA;EACE,iCAAiC;EACjC,eAAe;AACjB;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,kBAAkB;EAClB,SAAS;EACT,0BAA0B;EAC1B,gBAAgB;EAChB,YAAY;EACZ,iBAAiB;;EAEjB,qCAAqC;EACrC,kBAAkB;EAClB,eAAe;;EAEf,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,kBAAkB;EAClB,gBAAgB;EAChB,mBAAmB;EACnB,gBAAgB;EAChB,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB
aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,mBAAmB;EACnB,uBAAuB;EACvB,+BAA+B;EAC/B,kBAAkB;EAClB,qCAAqC;AACvC;;AAEA;EACE,WAAW;EACX,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,6BAA6B;EAC7B,yBAAyB;EACzB,mBAAmB;AACrB;;AAEA;EACE,gCAAgC;EAChC,aAAa;EACb,iBAAiB;AACnB;;AAEA;EACE,gCAAgC;EAChC,aAAa;AACf;;AAEA;EACE,eAAe;AACjB","sourcesContent":["html {\n  font-family: 'Roboto', sans-serif;\n  font-size: 15px;\n}\n\nbody {\n  letter-spacing: 0.5px;\n}\n\n#app {\n  position: absolute;\n  left: 50%;\n  transform: translate(-50%);\n  margin-top: 52px;\n  width: 382px;\n  min-height: 640px;\n\n  border: 1px solid rgba(0, 0, 0, 0.12);\n  border-radius: 4px;\n  padding: 0 16px;\n\n  display: flex;\n  flex-direction: column;\n}\n\n.title {\n  text-align: center;\n  margin-top: 52px;\n  margin-bottom: 16px;\n  font-weight: 600;\n  font-size: 34px;\n  line-height: 36px;\n}\n\n.main-wrap {\n  display: flex;\n  flex-direction: column;\n  gap: 28px;\n}\n\n.subtitle {\n  font-weight: 600;\n  font-size: 20px;\n  line-height: 24px;\n  letter-spacing: 0.15px;\n}\n\n.input-form {\n  /* display: flex; */\n  justify-content: space-between;\n}\n\n.hint {\n  display: block;\n  margin-bottom: 4px;\n  line-height: 24px;\n  font-weight: 400;\n  color: rgba(0, 0, 0, 0.87);\n}\n\n.winning-number-legend {\n  display: block;\n  margin-bottom: 4px;\n  line-height: 24px;\n  font-weight: 400;\n  color: rgba(0, 0, 0, 0.87);\n}\n\n.styled-input {\n  height: 36px;\n  border: 1px solid #b4b4b4;\n  box-sizing: border-box;\n  border-radius: 4px;\n}\n\n.styled-input:placeholder {\n  margin: 0px 10px;\n\n  font-family: Roboto;\n  font-style: normal;\n  font-weight: normal;\n  font-size: 15px;\n  line-height: 24px;\n\n  letter-spacing: 0.5px;\n  color: #8b8b8b;\n}\n\n.submit-button {\n  background: inherit;\n  border: none;\n  box-shadow: none;\n  overflow: visible;\n  cursor: pointer;\n\n  background: #00bcd4;\n  border-radius: 4px;\n  color: #fff;\n\n  font-style: normal;\n  font-weight: bold;\n  font-size: 14px;\n  line-height: 16px;\n\n  letter-spacing: 1.25px;\n  text-transform: uppercase;\n\n  height: 36px;\n}\n\n.submit-button:hover {\n  background: #80deea;\n}\n\n.submit-button:disabled {\n  background: #b4b4b4;\n}\n\n#payment-input {\n  width: 310px;\n}\n\n#payment-submit {\n  width: 56px;\n  float: right;\n}\n\n#ticket-section {\n  display: flex;\n  justify-content: space-between;\n}\n\n#ticket-list {\n  display: flex;\n  gap: 8px;\n  flex-wrap: wrap;\n  width: 286px;\n}\n\n#ticket-list {\n  display: flex;\n  gap: 8px;\n  flex-wrap: wrap;\n  width: 286px;\n}\n\n.ticket-list-row {\n  flex-direction: row;\n}\n\n.ticket-list-column {\n  flex-direction: column;\n}\n\n.ticket {\n  height: 36px;\n  font-size: 34px;\n  line-height: 36px;\n}\n\n.ticket > p {\n  width: max-content;\n  display: flex;\n}\n\n.ticket-numbers {\n  font-style: normal;\n  font-weight: normal;\n  font-size: 15px;\n  line-height: 36px;\n  vertical-align: middle;\n  margin-left: 8px;\n}\n\n#show-number-toggle-area {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n}\n\n.switch {\n  position: relative;\n  display: inline-block;\n}\n\n/* Hide default HTML checkbox */\n.switch input {\n  width: 30px;\n  height: 10px;\n  visibility: hidden;\n}\n\n/* The slider */\n.slider {\n  position: absolute;\n  cursor: pointer;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(33, 33, 33, 0.08);\n  -webkit-transition: 0.4s;\n  transition: 0.4s;\n}\n\n.slider:before {\n  position: absolute;\n  content: '';\n  height: 20px;\n  width: 20px;\n  left: 0px;\n  bottom: -3px;\n  background-color: rgb(250, 248, 248);\n  -webkit-transition: 0.4s;\n  transition: 0.4s;\n}\n\n/* switch on: background bar */\ninput:checked + .slider {\n  background-color: #80deea;\n}\n\n/* switch on : round */\ninput:checked + .slider:before {\n  -webkit-transform: translateX(14px);\n  -ms-transform: translateX(14px);\n  transform: translateX(14px);\n  background-color: #00bcd4;\n}\n\n/* Rounded sliders */\n.slider.round {\n  border-radius: 34px;\n  width: 34px;\n  height: 14px;\n}\n\n.slider.round:before {\n  border-radius: 50%;\n  box-shadow: 0 2px 2px rgba(0, 0, 0, 0.2);\n}\n\n#winning-number-section {\n  display: flex;\n  flex-direction: column;\n}\n\n#winning-number-form {\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 24px;\n}\n\n#winning-number-input-wrap {\n  display: flex;\n  gap: 8px;\n}\n\n.winning-number-input {\n  width: 34px;\n  text-align: center;\n}\n\n.winning-number-input::-webkit-outer-spin-button,\n.winning-number-input::-webkit-inner-spin-button {\n  -webkit-appearance: none;\n  margin: 0;\n}\n\n#bonus-number-fieldset {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n}\n\n#show-result-button {\n  margin-bottom: 39px;\n}\n\n.modal-overlay {\n  width: 100%;\n  height: 100%;\n  position: fixed;\n  left: 0;\n  top: 0;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: rgba(0, 0, 0, 0.3);\n}\n\n.modal-closed {\n  display: none;\n}\n\n.modal-window {\n  width: 350px;\n  padding: 40px 16px;\n  display: flex;\n  flex-direction: column;\n  gap: 32px;\n  align-items: center;\n  justify-content: center;\n  background: rgba(255, 255, 255);\n  border-radius: 4px;\n  border: 1px solid rgba(255, 255, 255);\n}\n\n.modal-content {\n  width: 100%;\n  text-align: center;\n}\n\n#result-table {\n  width: 100%;\n  border-top: 1px solid #dcdcdc;\n  border-collapse: collapse;\n  margin-bottom: 16px;\n}\n\n#result-table th {\n  border-bottom: 1px solid #dcdcdc;\n  padding: 10px;\n  font-weight: bold;\n}\n\n#result-table td {\n  border-bottom: 1px solid #dcdcdc;\n  padding: 10px;\n}\n\n#restart-button {\n  padding: 0 30px;\n}\n"],"sourceRoot":""}]);
// Exports
